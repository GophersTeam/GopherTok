CREATE TABLE `user` (
                        ...
                        `avatar` varchar(255) COLLATE utf8mb4_unicode_520_ci DEFAULT '' NOT NULL,
                        `background_image` varchar(255) COLLATE utf8mb4_unicode_520_ci DEFAULT '' NOT NULL,
                        `signature` varchar(255) COLLATE utf8mb4_unicode_520_ci DEFAULT '' NOT NULL,
